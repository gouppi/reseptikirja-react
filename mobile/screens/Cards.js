...
export default function Cards({ navigation }) {
	const {recipes, fetchRecipes} = usePantryContext();
				...
				ListEmptyComponent={() =>  {
					return searchParam.length ? (
						<View style={styles.center}>
							<Text>En löytänyt reseptejä hakusanallasi.</Text>
							<Text>Kokeile toista hakusanaa!</Text>
						</View>
						) :
					(
						<View style={styles.center}>
							<Text>Virhe noudettaessa reseptejä.</Text>
							<Text>Päivitä listaa vetämällä alaspäin.</Text>
						</View>
					)	
				}}
				ListHeaderComponent={
